...
parser.add_argument('--config', type=str, default='hanoi_3_disks',
                    help='Name of config') 
...
def get_chunks(iterable, chunks=14):
    lst = list(iterable)
...
def worker(grid):
    for a in grid:
        ...
        config.experiment.name = 'hanoi3_lr{}_lrg{}_rg{}_t{}_si{}_c{}'.format(a[0], a[1], a[2], a[3], a[4], a[5])
        model = agent(config)
...
if __name__ == '__main__':
    ...
    chunked_args = get_chunks(grid, chunks=4)
