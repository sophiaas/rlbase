...
class Hanoi(gym.Env):
    ...
    def set_action_space(self):
        ...
        self.action_key = {a: b for a,b in zip(range(self.n_actions), self.possible_moves)}
    ...
    def step(self, action):
        ...
        data = self.get_data()
        return copy.deepcopy(self.state), copy.deepcopy(reward), copy.deepcopy(self.done), data
