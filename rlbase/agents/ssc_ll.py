...
#             print('action lengths: {}'.format(action_lengths[i])) 
#             print('rewards[i]: {}'.format(rewards[i]))
#             print('r: {}'.format(r))
#             print('prev_return: {}'.format(prev_return))
...
#             print(step_data)
#             print('action length: {}'.format(step_data['action_length']))
        
            self.hl_memory.push(step_data) 
        
        return step_data, next_state, done, timestep
               
        
    def update(self):   
        # Convert list to tensor
#         print('hl length: {}'.format(len(self.hl_memory.state)))
#         print('ll length: {}'.format(len(self.memory.state)))
#         print('state length: {}'.format(len(self.memory.state)))
...
#         print('action_lengths: {}'.format(action_lengths.shape))
...
#             action_tracker = 1
            for t in range(1, self.config.training.max_episode_length+1):
                ...
                with torch.no_grad():
                    transition, state, done, timestep = self.step(state, timestep)
...
#                 action_tracker += transition['action_length']
                ...
                if timestep >= self.config.training.update_every:
                    self.update()
                    self.memory.clear()
                    self.hl_memory.clear()
                    timestep = 0
